...
!need to move this to an initializacion subroutine
      allocate(typeconstr(20), kforce(25), ro(20), rt(20), coef(20,10))
      allocate(atmsconstr(25,25), ndists(20))
...
! Print final date and time
 ...
 899  format(1x,I7,1x,9(f18.9,1x))
 345  format(2x, I7,    2x, 3(f18.9,2x))
